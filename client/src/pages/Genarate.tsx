                ...
                py-8 pb-28 lg:pb-8'>
                    <div className='grid lg:grid-cols-[400px_1fr] gap-8'>
                        ...
                        <div className={`space-y-6 ${id && 'pointer-events-none'}`}>
                            <div className='p-6 rounded-2xl bg-white/8 
                            border border-white/12 shadow-xl space-y-6'>
                                <div>
                                    <h2 className='text-xl font-bold text-zinc-100 mb-1'>Create Your Thumbnail</h2>
                                    <p className='text-sm text-zinc-400'>Describe your vision and let AI bring
                                        it to life
                                    </p>
                                </div>
                                ...
                                <div className='space-y-2'>
                                    ...
                                    <input type="text" value={title} onChange={(e)=>setTitle
                                        (e.target.value)} maxLength={100} placeholder='e.g., 10
                                         Tips for Better Sleep' className='w-full px-4 py-3
                            ...
                            {/* Aspect RationSelector */}
                            <AspectRatioSelector value={aspectRatio} onChange={setAspectRatio}/>
                            {/* StyleSelector */}
                            <StyleSelector value={style} onChange={setStyle} isOpen={styleDropdownOpen}
                            ...
                            <div className='space-y-2'>
                                ...
                                {!id && (
                                    ...
                                    className='text-[15x] w-full py-3.5 rounded-xl font-medium
                        ...
                        {/* RIGHT PANEL */}
                        <div className='p-6 rounded-2xl bg-white/8 border border-white/10
                        shadow-xl'>
