...
{value:ThumbnailStyle; onChange:(style:ThumbnailStyle)=>void;
    ...
    const styleDescription : Record<ThumbnailStyle,string> ={
        ...
        "Photorealisitic" : "Photo-based, natural looking",
        "Illustrated" : "Hand-drawn,artistic,creative",
        "Tech/Futurisitic" : "Modern,sleek,tech-inspired",
    }
  ...
  return (
    <div className='relative space-y-3 dark'>
        ...
        >
            ...
            <ChevronDownIcon className={['h-5 w-5 text-zinc-400 transition-transform transform',
